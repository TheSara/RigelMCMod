...
public class Command_lightwarp extends FreedomCommand
{
    ...
    public boolean run(final CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        ban.setReason("&cYou better stop being a asshole! And take this shitty phone.");
        ...
        new BukkitRunnable()
        {
            ...
            public void run()
            {
                ...
                // kick player
                player.kickPlayer(ChatColor.RED + "Get Fucked m8 -_-");
            }
