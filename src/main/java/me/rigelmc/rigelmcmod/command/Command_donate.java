...
public class Command_donate extends FreedomCommand
{
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        msg("LightWarp has to keep the server up, so your donation would be helpful.", ChatColor.AQUA);
        msg(" - Go to http://rigelmc.ga/donate/ to Donate. You can donate any amount!", ChatColor.AQUA);
        msg(" - Be sure to leave your Minecraft name in the Payment notes text field, so we know that you donated!", ChatColor.AQUA);
